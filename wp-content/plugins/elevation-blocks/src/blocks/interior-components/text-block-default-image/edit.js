...
const Edit = (props) => {
	...
	const controls = (
		<InspectorControls>
			...
			>
				<SelectControl
					label={__('Image Size', 'elevation-blocks')}
					value={imageSize}
					options={[
						{
							label: __('Small', 'elevation-blocks'),
							value: 'small',
						},
						{
							label: __('Medium', 'elevation-blocks'),
							value: 'medium',
						},
						{
							label: __('Large', 'elevation-blocks'),
							value: 'large',
						},
					]}
				...
				/>
				<SelectControl
					label={__('Image Position', 'elevation-blocks')}
					value={columnsDirection}
					options={[
						{
							label: __('Left', 'elevation-blocks'),
							value: 'default',
						},
						{
							label: __('Right', 'elevation-blocks'),
							value: 'inverse',
						},
					]}
					onChange={(value) =>
