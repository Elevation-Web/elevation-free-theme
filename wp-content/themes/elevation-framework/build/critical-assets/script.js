...
const globalAnimations = () => {
  ...
  const exclusionSelectors = ['.accordion-item__item p', '.banner-full-img img', '.video-full-screen-pop-up img', '.accordion-item__item img', '.accordion-item__item .cta', '.team-bios-with-pop-up .title', '.team-bios-with-pop-up img', '.team-bios-with-pop-up p', '.team-bios-with-pop-up .cta', '.no-animate *', '.no-animate'];
