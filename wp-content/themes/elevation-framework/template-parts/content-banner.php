...
/* Content */
$banner_image = get_template_directory_uri() . '/src/assets/images/interior-banner.jpg';
...
<section class="interior-banner">
	...
	<div class="container">
		<div class="row justify-content-<?= $banner_block_position; ?>">
			<div class="col-12 col-xl-<?= $banner_container_width ? $banner_container_width : '12'; ?>">
				<div class="banner-container <?= $banner_content_alignment; ?>">
