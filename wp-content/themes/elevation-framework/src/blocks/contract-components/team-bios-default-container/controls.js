				...
				<div style={{ marginBottom: '20px' }}>
					...
					{!!options && (
						<div
							...
							className="team-bios-default-container__options"
						>
							<div
								onClick={() =>
									setIsDropdownOpen(!isDropdownOpen)
								}
								className="team-bios-default-container__options__selected"
							>
								...
								<SearchControl
									...
									className="team-bios-default-container__options__search"
									ref={ref}
								/>
							</div>
							{isDropdownOpen && (
								<ul className="team-bios-default-container__options__dropdown">
									{options
										.filter((option) => {
										...
										.map((option) => (
											<li
												...
												className="team-bios-default-container__options__dropdown__item"
											>
												{option.title.rendered}
											</li>
										))}
