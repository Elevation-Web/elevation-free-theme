...
$menu_items = elevationMegaMenu('Menu 4 - All Variants w/o Main Nav Button');
?>
            ...
            <div class="mega-menu__container container">
              <div class="mega-menu__row">
                ...
                <div class="mega-menu__col col inner-wrapper">
                  ...
                  <ul class="mega-menu__nav<?= $item_type == 'option_2' ? ' sub-nav-header ' : ' '; ?>
                    <?= $menu_column_distribution ? ' column_size-' . esc_html($menu_column_distribution) : ' column_size-2'; ?>" role="menu">
                  ...
                  <aside class="box-aside mega-menu__col col-box-<?= $size_column ? esc_html($size_column) : '2'; ?>">
                    ...
                    ?>
                      ...
                      <figure class="mega-menu__figure">
                        ...
                        <?php endif; ?>
                        <?php Helpers::global_image($image_box, ['alt' => $alt_image_box, 'class' => '', 'size' => 'hd']); ?>
                          ...
                          ?>
                            ...
                            <div class="col">
                              <article class="card">
                                <div class="card__body">
                                  <a href="<?= get_permalink(); ?>">
                                    <?php if (isset($start_date) && !empty($start_date)) : ?> <span class="card__body__date h6">
                                  ...
                                  <article class="card">
                                    ...
                                    ?>
                                      <div class="card__header">
                                        <?php Helpers::global_image($image, ['alt' => $alt_image, 'class' => 'card__image card__image--hover-effect', 'size' => 'medium']); ?>
                                      </div>
                                    <?php endif; ?>
