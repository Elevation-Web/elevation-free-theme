...
/***/ "./src/blocks/interior-components/image-carousel-horizontal-centered/edit.js":
/*!***********************************************************************************!*\
  !*** ./src/blocks/interior-components/image-carousel-horizontal-centered/edit.js ***!
  \***********************************************************************************/
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/interior-components/image-carousel-horizontal-centered/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/blocks/interior-components/image-carousel-horizontal-centered/block.json");
/* harmony import */ var _preview_webp__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./preview.webp */ "./src/blocks/interior-components/image-carousel-horizontal-centered/preview.webp");
/* harmony import */ var _template__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./template */ "./src/blocks/interior-components/image-carousel-horizontal-centered/template.js");
...
/***/ "./src/blocks/interior-components/image-carousel-horizontal-centered/index.js":
/*!************************************************************************************!*\
  !*** ./src/blocks/interior-components/image-carousel-horizontal-centered/index.js ***!
  \************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/blocks/interior-components/image-carousel-horizontal-centered/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./src/blocks/interior-components/image-carousel-horizontal-centered/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./save */ "./src/blocks/interior-components/image-carousel-horizontal-centered/save.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/interior-components/image-carousel-horizontal-centered/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/interior-components/image-carousel-horizontal-centered/editor.scss");
...
/***/ "./src/blocks/interior-components/image-carousel-horizontal-centered/save.js":
/*!***********************************************************************************!*\
  !*** ./src/blocks/interior-components/image-carousel-horizontal-centered/save.js ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/interior-components/image-carousel-horizontal-centered/template.js":
/*!***************************************************************************************!*\
  !*** ./src/blocks/interior-components/image-carousel-horizontal-centered/template.js ***!
  \***************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/interior-components/image-carousel-horizontal-centered/editor.scss":
/*!***************************************************************************************!*\
  !*** ./src/blocks/interior-components/image-carousel-horizontal-centered/editor.scss ***!
  \***************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/interior-components/image-carousel-horizontal-centered/style.scss":
/*!**************************************************************************************!*\
  !*** ./src/blocks/interior-components/image-carousel-horizontal-centered/style.scss ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/interior-components/image-carousel-horizontal-centered/preview.webp":
/*!****************************************************************************************!*\
  !*** ./src/blocks/interior-components/image-carousel-horizontal-centered/preview.webp ***!
  \****************************************************************************************/
...
/***/ "./src/blocks/interior-components/image-carousel-horizontal-centered/block.json":
/*!**************************************************************************************!*\
  !*** ./src/blocks/interior-components/image-carousel-horizontal-centered/block.json ***!
  \**************************************************************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"title":"Image Carousel, Layout: Horizontal Centered","name":"elevation/interior-components--image-carousel-horizontal-centered","version":"1.0.0","category":"elevation-blocks","description":"Testimonials with title, description, Quote and Photo","textdomain":"elevation","supports":{"html":true,"align":false,"alignWide":false,"anchor":true,"color":{"background":true,"gradients":false,"text":false,"link":false,"border":false},"spacing":{"margin":["top","bottom"]},"interactivity":{"clientNavigation":true}},"attributes":{"id":{"type":"string","default":""},"is_slider":{"type":"boolean","default":true},"preview":{"type":"boolean","default":false},"speed":{"type":"string","default":"1000"},"pagination":{"type":"string","default":"yes"},"navigation":{"type":"string","default":"yes"},"scrollbar":{"type":"string","default":"yes"},"keyboard":{"type":"string","default":"yes"},"mousewheel":{"type":"string","default":"yes"}},"example":{"attributes":{"preview":true}},"script":["file:index.js"],"style":["file:style-index.css"],"editorStyle":["file:index.css"]}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/interior-components/image-carousel-horizontal-centered/index": 0,
/******/ 			"blocks/interior-components/image-carousel-horizontal-centered/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/interior-components/image-carousel-horizontal-centered/style-index"], () => (__webpack_require__("./src/blocks/interior-components/image-carousel-horizontal-centered/index.js")))
