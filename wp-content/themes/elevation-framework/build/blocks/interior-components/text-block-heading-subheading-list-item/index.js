...
/***/ "./src/blocks/interior-components/text-block-heading-subheading-list-item/edit.js":
/*!****************************************************************************************!*\
  !*** ./src/blocks/interior-components/text-block-heading-subheading-list-item/edit.js ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _components_ColorPicker__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../components/ColorPicker */ "./src/blocks/components/ColorPicker.js");
/* harmony import */ var _preview_webp__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./preview.webp */ "./src/blocks/interior-components/text-block-heading-subheading-list-item/preview.webp");
/* harmony import */ var _template__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./template */ "./src/blocks/interior-components/text-block-heading-subheading-list-item/template.js");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./block.json */ "./src/blocks/interior-components/text-block-heading-subheading-list-item/block.json");
...
const Edit = props => {
  ...
  const controls = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
      ...
      initialOpen: true,
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_components_ColorPicker__WEBPACK_IMPORTED_MODULE_4__.ColorPicker, {
...
/***/ "./src/blocks/interior-components/text-block-heading-subheading-list-item/save.js":
/*!****************************************************************************************!*\
  !*** ./src/blocks/interior-components/text-block-heading-subheading-list-item/save.js ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block.json */ "./src/blocks/interior-components/text-block-heading-subheading-list-item/block.json");
...
/***/ "./src/blocks/interior-components/text-block-heading-subheading-list-item/template.js":
/*!********************************************************************************************!*\
  !*** ./src/blocks/interior-components/text-block-heading-subheading-list-item/template.js ***!
  \********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const template = [['core/heading', {
  ...
  content: 'Name of Block: Text-Block, Layout: Heading+Subheading List-Default. 30 words per paragraph. Id cursus metus aliquam eleifend mi in nulla posuere sollicitudin aliquam ultrices sagittis orci a scelerisque purus semper eget duis at tellus at.'
}]];
...
/***/ "./src/blocks/interior-components/text-block-heading-subheading-list-item/preview.webp":
/*!*********************************************************************************************!*\
  !*** ./src/blocks/interior-components/text-block-heading-subheading-list-item/preview.webp ***!
  \*********************************************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "images/preview.ef0a8eb7.webp";
...
/***/ "./src/blocks/interior-components/text-block-heading-subheading-list-item/block.json":
/*!*******************************************************************************************!*\
  !*** ./src/blocks/interior-components/text-block-heading-subheading-list-item/block.json ***!
  \*******************************************************************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"title":"Text Block, Layout: Heading + Subheading + List Item.","name":"elevation/interior-components--text-block-heading-subheading-list-item","version":"1.0.0","category":"elevation-blocks","description":"Text Block, Layout:  Heading + Subheading + List Item.","textdomain":"elevation","ancestor":["elevation/interior-components--text-block-heading-subheading-list"],"supports":{"html":true,"align":false,"alignWide":false,"color":{"background":true,"gradients":false,"text":false,"link":false,"border":false},"spacing":{"margin":["top","bottom"],"padding":["top","right","bottom","left"]}},"attributes":{"id":{"type":"string","default":""},"preview":{"type":"boolean","default":false},"borderColor":{"type":"string","default":""}},"editorScript":["file:index.js"]}');
...
(() => {
/*!*****************************************************************************************!*\
  !*** ./src/blocks/interior-components/text-block-heading-subheading-list-item/index.js ***!
  \*****************************************************************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block.json */ "./src/blocks/interior-components/text-block-heading-subheading-list-item/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./src/blocks/interior-components/text-block-heading-subheading-list-item/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./save */ "./src/blocks/interior-components/text-block-heading-subheading-list-item/save.js");
