...
/***/ "./src/blocks/cards-images/edit.js":
/*!*****************************************!*\
  !*** ./src/blocks/cards-images/edit.js ***!
  \*****************************************/
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/blocks/cards-images/block.json");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/cards-images/editor.scss");
/* harmony import */ var _preview_webp__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./preview.webp */ "./src/blocks/cards-images/preview.webp");
/* harmony import */ var _components_ImageWithFocalPoint__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/ImageWithFocalPoint */ "./src/blocks/components/ImageWithFocalPoint.js");
...
/* harmony import */ var _utils_getImageAttributes__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/getImageAttributes */ "./src/blocks/utils/getImageAttributes.js");
...
const Edit = props => {
  const CARDS_ALLOWED_BLOCKS = ['elevation/image-with-srcset', 'core/heading', 'core/paragraph', 'elevation/buttons'];
  const CARDS_TEMPLATE = [['elevation/image-with-srcset', {
    img: {
  ...
  const addMedia = media => {
    const {
      ...
      alt,
      id
    } = (0,_utils_getImageAttributes__WEBPACK_IMPORTED_MODULE_9__.getImageAttributes)(media);
    setAttributes({
      img: { ...img,
        url: fullSize.url,
        alt,
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, controls, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    id: anchor || id,
    ...blockProps
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_ImageWithFocalPoint__WEBPACK_IMPORTED_MODULE_7__.ImageWithFocalPoint, {
    img: img,
...
/***/ "./src/blocks/cards-images/index.js":
/*!******************************************!*\
  !*** ./src/blocks/cards-images/index.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/blocks/cards-images/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./src/blocks/cards-images/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./save */ "./src/blocks/cards-images/save.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/cards-images/style.scss");
...
/***/ "./src/blocks/cards-images/save.js":
/*!*****************************************!*\
  !*** ./src/blocks/cards-images/save.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block.json */ "./src/blocks/cards-images/block.json");
...
const RemoveImageButton = ({
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Remove Image', 'text-domain'));
};
const UploadMedia = ({
  attributes,
  setAttributes,
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUploadCheck, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUpload, {
    onSelect: media => {
      console.log(media);
      const newAttrs = attrId === 'imgDesktop' ? { ...attributes,
        [attrId]: media.url,
        imgAlt: media.alt
      } : { ...attributes,
        [attrId]: media.url
    ...
    render: ({
      ...
      primary: true,
      isLarge: true
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Select Background Image', 'text-domain'))
  }));
};
...
/***/ "./src/blocks/cards-images/editor.scss":
/*!*********************************************!*\
  !*** ./src/blocks/cards-images/editor.scss ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/cards-images/style.scss":
/*!********************************************!*\
  !*** ./src/blocks/cards-images/style.scss ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/cards-images/preview.webp":
/*!**********************************************!*\
  !*** ./src/blocks/cards-images/preview.webp ***!
  \**********************************************/
...
/***/ "./src/blocks/cards-images/block.json":
/*!********************************************!*\
  !*** ./src/blocks/cards-images/block.json ***!
  \********************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"title":"Cards | Layout: Background images + icons","name":"elevation/cards-images","version":"1.0.0","category":"elevation-blocks","description":"Cards with title, description, background images and icons","textdomain":"elevation","parent":["elevation/cards-wrapper"],"supports":{"html":true,"align":false,"alignWide":false,"color":{"background":true,"gradients":false,"text":false,"link":false,"border":false},"spacing":{"margin":["top","bottom"]}},"attributes":{"id":{"type":"string","default":""},"preview":{"type":"boolean","default":false},"img":{"type":"object","default":{"url":"","alt":"","id":0,"srcset":"","width":0,"height":0,"sizes":"","focalPoint":{"x":0.5,"y":0.5}}}},"editorScript":["file:index.js"],"editorStyle":["file:index.css"]}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/cards-images/index": 0,
/******/ 			"blocks/cards-images/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/cards-images/style-index"], () => (__webpack_require__("./src/blocks/cards-images/index.js")))
