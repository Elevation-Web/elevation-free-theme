...
/***/ "./src/blocks/interior-components/image-carousel copy/edit.js":
/*!********************************************************************!*\
  !*** ./src/blocks/interior-components/image-carousel copy/edit.js ***!
  \********************************************************************/
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/interior-components/image-carousel copy/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/blocks/interior-components/image-carousel copy/block.json");
/* harmony import */ var _preview_webp__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./preview.webp */ "./src/blocks/interior-components/image-carousel copy/preview.webp");
/* harmony import */ var _template__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./template */ "./src/blocks/interior-components/image-carousel copy/template.js");
...
/***/ "./src/blocks/interior-components/image-carousel copy/index.js":
/*!*********************************************************************!*\
  !*** ./src/blocks/interior-components/image-carousel copy/index.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/blocks/interior-components/image-carousel copy/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./src/blocks/interior-components/image-carousel copy/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./save */ "./src/blocks/interior-components/image-carousel copy/save.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/interior-components/image-carousel copy/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/interior-components/image-carousel copy/editor.scss");
...
/***/ "./src/blocks/interior-components/image-carousel copy/save.js":
/*!********************************************************************!*\
  !*** ./src/blocks/interior-components/image-carousel copy/save.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/interior-components/image-carousel copy/template.js":
/*!************************************************************************!*\
  !*** ./src/blocks/interior-components/image-carousel copy/template.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/interior-components/image-carousel copy/editor.scss":
/*!************************************************************************!*\
  !*** ./src/blocks/interior-components/image-carousel copy/editor.scss ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/interior-components/image-carousel copy/style.scss":
/*!***********************************************************************!*\
  !*** ./src/blocks/interior-components/image-carousel copy/style.scss ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/interior-components/image-carousel copy/preview.webp":
/*!*************************************************************************!*\
  !*** ./src/blocks/interior-components/image-carousel copy/preview.webp ***!
  \*************************************************************************/
...
/***/ "./src/blocks/interior-components/image-carousel copy/block.json":
/*!***********************************************************************!*\
  !*** ./src/blocks/interior-components/image-carousel copy/block.json ***!
  \***********************************************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"title":"Image Carousel, Item","name":"elevation/interior-components--image-carousel","version":"1.0.0","category":"elevation-blocks","description":"Image Container","textdomain":"elevation","parent":["elevation/interior-components--swiper"],"supports":{"html":true,"align":false,"alignWide":false,"anchor":true,"color":{"background":true,"gradients":false,"text":false,"link":false,"border":false},"spacing":{"margin":["top","bottom"]},"interactivity":{"clientNavigation":true}},"attributes":{"id":{"type":"string","default":""},"preview":{"type":"boolean","default":false}},"example":{"attributes":{"preview":true}},"script":["file:index.js"],"style":["file:style-index.css"],"editorStyle":["file:index.css"]}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/interior-components/image-carousel copy/index": 0,
/******/ 			"blocks/interior-components/image-carousel copy/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/interior-components/image-carousel copy/style-index"], () => (__webpack_require__("./src/blocks/interior-components/image-carousel copy/index.js")))
