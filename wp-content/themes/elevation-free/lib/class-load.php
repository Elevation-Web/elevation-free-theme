...
namespace ElevationFree\Lib;

/**
 * Class Load
 *
 * @package ElevationFree\Lib
 */
final class Load {
		...
		if ( ! class_exists( $class_to_load ) ) {
			...
			if ( is_readable( $class_file ) ) {
				include_once $class_file;
					...
					$warning_message = sprintf( esc_html__( '"Can\'t find %1$s" for "%2$s" in "%3$s".', 'elevation-free' ), $class_file, $class_to_load, __NAMESPACE__ );
