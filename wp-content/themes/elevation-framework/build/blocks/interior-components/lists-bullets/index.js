...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/interior-components/lists-bullets/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/blocks/interior-components/lists-bullets/block.json");
/* harmony import */ var _preview_webp__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./preview.webp */ "./src/blocks/interior-components/lists-bullets/preview.webp");
/* harmony import */ var _template__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./template */ "./src/blocks/interior-components/lists-bullets/template.js");
...
const Edit = props => {
  ...
  const innerBlocksProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useInnerBlocksProps)(blockProps, {
    template: altTemplate ? _template__WEBPACK_IMPORTED_MODULE_7__.TEMPLATE_ALT : _template__WEBPACK_IMPORTED_MODULE_7__.TEMPLATE,
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/interior-components/lists-bullets/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/interior-components/lists-bullets/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/interior-components/lists-bullets/save.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/interior-components/lists-bullets/style.scss");
...
/* harmony export */   TEMPLATE_ALT: () => (/* binding */ TEMPLATE_ALT),
...
const TEMPLATE_ALT = [['elevation/interior-components--group', {
  tagName: 'ul',
  className: 'lists-bullets__container--alt',
  allowedBlocks: ['elevation/interior-components--lists-bullets-item']
}, [['elevation/interior-components--lists-bullets-item', {}], ['elevation/interior-components--lists-bullets-item', {}]]]];
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"title":"Lists, Layout: Bullets","name":"elevation/interior-components--lists-bullets","version":"1.0.0","category":"elevation-blocks","icon":"button","description":"List container.","textdomain":"elevation","supports":{"html":true,"anchor":true,"align":["full"],"alignWide":false,"ariaLabel":false,"color":{"background":true,"gradients":false,"text":true,"link":false,"border":false},"spacing":{"margin":["top","bottom"],"blockGap":false},"layout":false,"interactivity":{"clientNavigation":true}},"attributes":{"id":{"type":"string","default":""},"align":{"type":"array","default":""},"preview":{"type":"boolean","default":false},"altTemplate":{"type":"boolean","default":false}},"example":{"attributes":{"preview":true}},"editorScript":["file:index.js"],"style":["file:style-index.css"],"editorStyle":["file:index.css"]}');
