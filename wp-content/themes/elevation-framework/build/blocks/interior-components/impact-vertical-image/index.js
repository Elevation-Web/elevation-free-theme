		...
		t = {
			3695: (e, t, o) => {
				const r = window.wp.blocks,
					i = JSON.parse(
						'{"title":"Impact, Layout: Vertical Image","name":"elevation/interior-components--impact-vertical-image"}'
					),
					n = (window.wp.i18n, window.wp.blockEditor),
					a = window.wp.element,
					c = (e) => {
						const t = e.split('/')[1].split('--');
						return { blockId: t.join('/'), name: t[1] };
					},
					l = o.p + 'images/preview.7edb33fd.webp',
					s = [
						[
							...
							[
								[
									'elevation/interior-components--group',
									{
										...
										color: 'ui-base-white',
										className:
											'impact-vertical-image__container',
										backgroundColor:
									...
									[
										...
										[
											'elevation/interior-components--group',
											{
												...
												color: 'ui-base-white',
												className:
													'impact-vertical-image__content-wrapper',
											},
											[
												[
													'core/heading',
												...
												[
													...
													{
														content:
															'Maximum 20 words. Orci ac auctor augue mauris augue neque gravida in fermentum et sollicitudin ac orci.',
														align: 'center',
													},
												],
												[
					...
					u = (e) => {
						const { attributes: t, setAttributes: o } = e,
							{ backgroundColor: r } = t,
							i = (0, n.useSetting)('color.palette');
						(0, a.useEffect)(() => {
							c('backgroundColor');
						}, []);
						const c = (e) => {
							if (!t[e].includes('#')) {
								const r = i.reduce((o, r) =>
									r.slug == t[e] ? r.color : o
								);
								r && o({ [e]: r?.color || r });
							}
						};
						return (0, m.jsx)(n.InspectorControls, {
							children: (0, m.jsx)(n.PanelColorSettings, {
				...
				(0, r.registerBlockType)(g, {
					...
					edit: (e) => {
						const { name: t } = i,
							...
							k = (0, n.useBlockProps)({
								className: `${o} alignfull`,
								style: { backgroundColor: f },
							}),
							x = (0, n.useInnerBlocksProps)(k, {
								template: s,
					...
					save: (e) => {
						const { name: t } = i,
							{ name: o, blockId: r } = c(t),
							{ attributes: a } = e,
							{ anchor: l, id: s, backgroundColor: p } = a,
							u = n.useBlockProps.save({
								className: `${o} counter alignfull`,
						...
						return (0, m.jsx)('div', {
							...
							id: l || s,
							...u,
							children: (0, m.jsx)(n.InnerBlocks.Content, {}),
						});
					},
				});
			},
		...
		(r.O = (t, o, i, n) => {
			if (!o) {
				...
				for (p = 0; p < e.length; p++) {
					for (var [o, i, n] = e[p], c = !0, l = 0; l < o.length; l++)
						(!1 & n || a >= n) &&
		...
		(() => {
			...
			var t = (t, o) => {
					...
					for (t && t(o); s < a.length; s++)
						(n = a[s]), r.o(e, n) && e[n] && e[n][0](), (e[n] = 0);
					return r.O(p);
				},
				o = (globalThis.webpackChunkelevation_framework =
					globalThis.webpackChunkelevation_framework || []);
			o.forEach(t.bind(null, 0)), (o.push = t.bind(null, o.push.bind(o)));
		})();
	var i = r.O(void 0, [969], () => r(3695));
	i = r.O(i);
})();
