...
function initSwiper(swiperSelector) {
  ...
  if (carousels) {
    carousels.forEach(carousel => {
      ...
      if (id) {
        ...
        const swiperCarousel = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](`#${id}`, {
          // Optional parameters
          loop: true,
          // loopAdditionalSlides,
          // rewind,
...
(0,_assets_scripts_utilities_swiper__WEBPACK_IMPORTED_MODULE_0__["default"])('.swiper__container');
})();
