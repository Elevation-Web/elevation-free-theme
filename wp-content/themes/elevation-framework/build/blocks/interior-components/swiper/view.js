...
const getSwiperParams = dataset => {
  ...
  const disableOnInteraction = dataset['disable-on-interaction'] ? true : false;
  return {
    loop,
    centeredSlides,
    grabCursor,
    ...
    breakpoints: {
      ...
      1200: {
        ...
        slidesPerView: perviewSlider !== null && perviewSlider !== void 0 ? perviewSlider : slidesPerViewXl
      },
      1400: {
        spaceBetween: spaceBetweenXxl,
        slidesPerView: perviewSlider !== null && perviewSlider !== void 0 ? perviewSlider : slidesPerViewXxl
      }
    }
  };
};
...
(0,_assets_scripts_utilities_swiper__WEBPACK_IMPORTED_MODULE_0__["default"])('.testimonials__swipper');
})();
