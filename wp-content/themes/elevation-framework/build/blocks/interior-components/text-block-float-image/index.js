...
/***/ "./src/blocks/interior-components/text-block-float-image/edit.js":
/*!***********************************************************************!*\
  !*** ./src/blocks/interior-components/text-block-float-image/edit.js ***!
  \***********************************************************************/
...
/* harmony import */ var _preview_webp__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./preview.webp */ "./src/blocks/interior-components/text-block-float-image/preview.webp");
/* harmony import */ var _template__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./template */ "./src/blocks/interior-components/text-block-float-image/template.js");
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/interior-components/text-block-float-image/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/blocks/interior-components/text-block-float-image/block.json");
  ...
  if (preview) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("div", {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("img", {
        src: _preview_webp__WEBPACK_IMPORTED_MODULE_3__,
        alt: "Preview",
        style: {
          objectFit: 'contain',
          maxHeight: '100%',
...
/***/ "./src/blocks/interior-components/text-block-float-image/index.js":
/*!************************************************************************!*\
  !*** ./src/blocks/interior-components/text-block-float-image/index.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block.json */ "./src/blocks/interior-components/text-block-float-image/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./src/blocks/interior-components/text-block-float-image/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./save */ "./src/blocks/interior-components/text-block-float-image/save.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/interior-components/text-block-float-image/style.scss");
...
/***/ "./src/blocks/interior-components/text-block-float-image/save.js":
/*!***********************************************************************!*\
  !*** ./src/blocks/interior-components/text-block-float-image/save.js ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/interior-components/text-block-float-image/template.js":
/*!***************************************************************************!*\
  !*** ./src/blocks/interior-components/text-block-float-image/template.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const template = [['elevation/interior-components--custom-container', {
  ...
  content: 'H2. Subheading lorem aliquam malesuada bibendum arcu vitae elementum curabitur vitae nunc sed velit dignissim sodales',
  level: 2,
  fontSize: 'h4'
}], ['core/paragraph', {
  content: 'Name of Block: Text-Block, Layout: Float Image. Ideal maximum 50 words per paragraph. Libero enim sed faucibus turpis in eu mi bibendum neque egestas congue quisque egestas diam in arcu cursus euismod quis viverra nibh cras pulvinar mattis nunc sed blandit libero volutpat sed cras ornare arcu dui vivamus arcu felis bibendum ut tristique et egestas quis ipsum suspendisse.'
}], ['core/paragraph', {
  content: 'Tincidunt id aliquet risus feugiat in ante metus dictum at tempor <strong>euismod lacinia at quis risus sed vulputate odio ut enim blandit volutpat maecenas volutpat blandit aliquam etiam erat velit.</strong>'
}], ['core/paragraph', {
  content: 'Accumsan sit amet nulla facilisi morbi tempus iaculis urna id volutpat lacus laoreet non curabitur gravida arcu ac tortor dignissim convallis aenean et tortor at risus viverra <a href="#">adipiscing at in tellus integer feugiat scelerisque</a> varius morbi enim nunc faucibus a pellentesque sit amet porttitor eget dolor morbi non arcu risus.'
}]]]]]];
...
/***/ "./src/blocks/interior-components/text-block-float-image/editor.scss":
/*!***************************************************************************!*\
  !*** ./src/blocks/interior-components/text-block-float-image/editor.scss ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/interior-components/text-block-float-image/style.scss":
/*!**************************************************************************!*\
  !*** ./src/blocks/interior-components/text-block-float-image/style.scss ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/interior-components/text-block-float-image/preview.webp":
/*!****************************************************************************!*\
  !*** ./src/blocks/interior-components/text-block-float-image/preview.webp ***!
  \****************************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "images/preview.256be34b.webp";
...
/***/ "./src/blocks/interior-components/text-block-float-image/block.json":
/*!**************************************************************************!*\
  !*** ./src/blocks/interior-components/text-block-float-image/block.json ***!
  \**************************************************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"title":"Text Block, Layout: Float Image","name":"elevation/interior-components--text-block-float-image","version":"1.0.0","category":"elevation-blocks","description":"Text Block, Layout: Float Image","textdomain":"elevation","supports":{"html":true,"align":false,"alignWide":false,"color":{"background":true,"gradients":false,"text":false,"link":false,"border":false},"spacing":{"margin":["top","bottom"],"padding":["top","right","bottom","left"]}},"attributes":{"id":{"type":"string","default":""},"preview":{"type":"boolean","default":false}},"editorScript":["file:index.js"],"style":["file:style-index.css"],"editorStyle":["file:index.css"]}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/interior-components/text-block-float-image/index": 0,
/******/ 			"blocks/interior-components/text-block-float-image/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/interior-components/text-block-float-image/style-index"], () => (__webpack_require__("./src/blocks/interior-components/text-block-float-image/index.js")))
